      ...
      return (
        r(t, [
          ...
          },
          {
            ...
            value: function (t, e) {
              return (
                this.el.addEventListener(t, function (t) {
        ...
        r(t, [
          ...
          },
          {
            ...
            value: function (e, n) {
              return (
                (n = n || e),
                t.create(this.x * e, this.y * n, this.w * e, this.h * n)
              );
            },
          },
          {
  ...
  function (t, e, n) {
    ...
    e.default = function (t, e, n, r) {
      ...
      function u(t) {
        ...
        e.pageX && e.pageY && n(e.pageX - i, e.pageY - o),
        ...
        i(t, [
          {
            key: "move",
            value: function (t, e) {
              return o.default.fromPoints(
                this.locked,
                this.translateStuckPoint(t, e),
              );
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t, e, n) {
              return o.default.getMax(
                Math.abs(this.locked[0] - t),
                Math.abs(this.locked[1] - e),
                n,
              );
            },
          },
        ...
        r(e, [
          ...
          },
          {
            ...
            value: function () {
              return (
                !!this.enabled &&
                (this.active ? this.active.el.focus() : this.el.focus(), this)
              );
            },
          },
          {
            ...
            value: function () {
              ...
              for (var e = Array.from(this.crops); e.length > t; )
                this.removeWidget(e.shift());
              return this;
            },
          },
          {
            ...
            value: function () {
              ...
              return (
                !!this.enabled &&
                !(null !== e.multiMax && t >= e.multiMax) &&
                !(!e.multi && t >= e.multiMin)
              );
            },
          },
          {
            ...
            value: function () {
              ...
              return (
                !!this.enabled &&
                !(this.active && !this.active.options.canRemove) &&
                !(!e.canRemove || t <= e.multiMin)
              );
            },
          },
          {
            ...
            value: function () {
              ...
              (0, s.default)(
                ...
                function (s, u, f) {
                  return (
                    !!a.canCreate() &&
                    ((t = (a.options.widgetConstructor || o.default).create(
                      a.options,
                    )),
                    ((e = t.pos).x =
                      f.pageX - a.el.offsetParent.offsetLeft - a.el.offsetLeft),
                    (e.y =
                      f.pageY - a.el.offsetParent.offsetTop - a.el.offsetTop),
                    (n = a.el.offsetWidth),
                    (r = a.el.offsetHeight),
                    a.addWidget(t),
                    (i = c.default.create(e, n, r, "se")),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                n.render(t.unscale(this.scalex, this.scaley)),
                this.addWidget(n),
                n.el.focus(),
                n
              );
          ...
          },
          {
            ...
            value: function () {
              ...
              (function t(e, n, r) {
                ...
                this.crops &&
                  Array.from(this.crops).forEach(function (e) {
  ...
  function (t, e, n) {
        ...
        i(e, [
          ...
          },
          {
            ...
            value: function (t, e, n) {
              var r = this,
                i = this;
              return (
                (n = n || i.options.animateEasingFunction || "swing"),
                (e = e || i.options.animateFrames || 30),
                (0, d.default)(
                  i.el,
                  i.pos,
                  t,
          ...
          },
          {
            ...
            value: function () {
              var t = this;
              return (
                this.options.handles.forEach(function (e) {
                  var n,
                    r = a.default.create("jcrop-handle " + e);
                  r.appendTo(t.el),
                    (0, u.default)(
                      r.el,
                      function () {
                        ...
                        var r = t.el.parentElement,
                          ...
                          o = r.offsetHeight;
                        return (
                          (n = f.default.create(c.default.from(t.el), i, o, e)),
                          t.aspect && (n.aspect = t.aspect),
                          t.el.focus(),
                          t.emit("crop.active"),
                          !0
                        );
          ...
          },
          {
            ...
            value: function (t) {
              return (
                (t = t || this.pos),
                (this.el.style.top = Math.round(t.y) + "px"),
                (this.el.style.left = Math.round(t.x) + "px"),
                (this.el.style.width = Math.round(t.w) + "px"),
                (this.el.style.height = Math.round(t.h) + "px"),
                (this.pos = t),
    ...
    (v.create = function () {
      ...
      return (
        ...
        (e.className = n.cropperClass || "jcrop-widget"),
        new (t.widgetConstructor || v)(e, n)
      );
    }),
      (e.default = v);
  },
    ...
    var u = (function (t) {
      function e(t) {
        ...
        return (
          ...
          r.initOptions(),
          r.setOptions((0, i.default)({}, a.default, n)),
          r
        );
      }
      return (
        ...
        r(e, [
          {
            ...
            value: function (t) {
              var e = this;
              return (
                (this.options = (0, i.default)({}, this.options, t)),
  ...
  function (t, e, n) {
    ...
    var r = (t.exports = {
      ...
      inOutBounce: function (t, e, n, i) {
        return t < i / 2
          ? 0.5 * r.inBounce(2 * t, 0, n, i) + e
          : 0.5 * r.outBounce(2 * t - i, 0, n, i) + 0.5 * n + e;
      },
    });
  },
  function (t, e, n) {
        ...
        r(t, [
              ...
              var t = this,
                e =
                  arguments.length > 0 && void 0 !== arguments[0]
                    ? arguments[0]
                    : {};
              (this.active = void 0 === e.shade || e.shade),
                ...
                this.el.addEventListener(
                  "crop.update",
                  function (e) {
                    e.cropTarget.isActive() &&
                      e.cropTarget.options.shade &&
                      t.adjust(e.cropTarget.pos);
                  },
                  !1,
                ),
                this.enable();
          ...
          },
          {
            ...
            value: function (t) {
              ...
              (n.t.h = t.y),
                (n.b.h = e.h - t.y2),
                (n.t.w = n.b.w = Math.floor(t.w)),
                (n.l.w = n.t.x = n.b.x = Math.ceil(t.x)),
                (n.r.w = e.w - (Math.ceil(t.x) + Math.floor(t.w)));
            },
          },
          {
            key: "keys",
    ...
    (c.create = function (t, e) {
      ...
      return (
        (n.className = r + " " + e),
        new c(n).color(t.shadeColor).opacity(t.shadeOpacity)
      );
    }),
      (c.Manager = u),
      (e.default = c);
  ...
  function (t, e, n) {
    ...
    function b(t) {
      var e =
        arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
      return (
        (e = (0, r.default)({}, i.default, e)),
        "string" == typeof t && (t = document.getElementById(t)),
        "IMG" === t.tagName ? new a.default(t, e) : new o.default(t, e)
      );
    }
    (e.Stage = o.default),
      (e.defaults = i.default),
      (e.Dragger = f.default),
      (e.Widget = s.default),
      (e.Rect = l.default),
      (e.Handle = c.default),
  ...
  function (t, e, n) {
    ...
    var u = (function (t) {
      function e(t, n) {
        ...
        return (
          (i.srcEl = t),
          (t.onload = i.resizeToImage.bind(i)),
          i.resizeToImage(),
          i.initResizeObserver(),
          i
        );
      }
      return (
          ...
          },
          {
            ...
            value: function () {
              var t = this.getImageDimensions(),
                ...
                s = a[0],
                u = a[1];
              (this.el.style.width = n + "px"),
                (this.el.style.height = i + "px"),
                this.rescaleWidgets(n / s, i / u),
                (this.scalex = s / n),
                (this.scaley = u / i),
                this.refresh();
            },
