...
class Command(BaseCommand):
    help = "Sync category symbols from assets directory to database"
    ...
    def handle(self, *args, **options):
        ...
        for category in categories:
            ...
            for style in styles:
                ...
                expected_slug = self._get_expected_slug(category)
                ...
                symbol = self._get_or_create_symbol(
                    svg_path, style, expected_slug, license, dry_run
                )
    ...
    def _get_expected_slug(self, category):
        """Get expected symbol slug for a category."""
        # For child categories, use child slug
        # For parent categories, use parent slug
        return category.slug
