...
class LicenseAdmin(ModelAdmin):
    ...
    view_on_site = True  # type: ignore[misc]  # pyright: ignore[reportIncompatiblePropertyOverride, reportAssignmentType]  # Django admin idiom
