...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("-s", "--save", action='store_true', help="Save entries from database as defaults (overwrite fixtures/organizations.yml)")
        parser.add_argument("-m", "--ignore-media", action='store_true', help="Ignore media files (do not copy or remove)")
        self._parser = parser
