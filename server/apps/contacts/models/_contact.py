...
class Contact(TimeStampedModel):
    ...
    name = models.CharField(
        blank=True, default="", max_length=70, verbose_name=_("Name")
    )
    email = models.EmailField(
        blank=True, default="", max_length=70, verbose_name=_("E-Mail")
    )
    phone = models.CharField(
        blank=True, default="", max_length=30, verbose_name=_("Phone")
    )
    mobile = models.CharField(
        blank=True, default="", max_length=30, verbose_name=_("Mobile")
    )
    # function = models.CharField(blank=True, max_length=50, help_text=_("Function (e.g. hut warden)"))  # maybe as enum?
    function = models.ForeignKey(
        ContactFunction, on_delete=models.RESTRICT, related_name="contacts"
    )
    url = models.URLField(blank=True, default="", max_length=200, verbose_name=_("URL"))
    address = models.CharField(
        blank=True, default="", max_length=200, verbose_name=_("Address")
    )
    note = models.TextField(
        blank=True, null=True, max_length=500, verbose_name=_("Note")
    )
