...
class OwnerContactAssociation(TimeStampedModel):
    ...
    contact = models.ForeignKey(
        Contact, on_delete=models.CASCADE, related_name="owner_details", verbose_name=_("Contact"), db_index=True
    )
    owner = models.ForeignKey("Owner", on_delete=models.CASCADE, verbose_name=_("Owner"), db_index=True)
